...
<html>
	...
	<body>
		<div class="navbar">
			<a href="./feed.php">Geral</a>
			<a href="./seguindo.php" class="selected">Seguindo</a>
		...
		<div class="postFeed">
			<?php
				if (count($posts['Posts']))
				{
					...
					{
						if (in_array($posts['Posts'][$i]['Id'], $_SESSION["follow"]))
						{
				...
				{
					echo "<h2 style='text-align: center'>Nada por aqui... Comece a seguir posts!</h2>".PHP_EOL;
				}
			?>
		</div>
